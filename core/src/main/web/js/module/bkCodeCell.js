...
/**
 * M_bkCodeCell
 * This module holds the logic for code cell, which is a typed {@link bkCell}. The code cell contains an input cell
 * an output cell ({@link bkCodeCellOutput}) and cell menus.
 */
(function () {
    'use strict';
            ...
            controller: function (
                ...
                $scope.$watch("isShowInput()", function (newValue, oldValue) {
                    if ($scope.cm && newValue === true && newValue !== oldValue) {
                        Q.fcall(function () { $scope.cm.refresh(); });
                    }
                });
